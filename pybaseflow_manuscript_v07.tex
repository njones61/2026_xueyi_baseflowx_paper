...
The conductivity mass balance method~\cite{Stewart2007} separates baseflow using specific conductance (SC) as a conservative tracer, an approach that has been extended to continuous estimation from discrete water-quality measurements~\cite{Miller2015}. From the two-component mass balance:
\begin{equation}
\label{eq:cmb}
