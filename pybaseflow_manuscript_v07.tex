...
\begin{table}[H]
\caption{Baseflow index (BFI) values for Fish River (USGS 01013500, 2019--2020) computed by each method in \texttt{pybaseflow}.\label{tab:bfi}}
\small
...
Table~\ref{tab:comparison} compares \texttt{pybaseflow} with existing baseflow separation tools across several dimensions relevant to modern hydrological practice.
